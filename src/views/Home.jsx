...
const Home = () => {
  return (
    <Grid container spacing={2} sx={{ margin: "20px" }}>
      <Grid item xs={12}>
        <Typography variant="h4" gutterBottom>Sofanic is revolutionizing the way you learn by leveraging the power of artificial intelligence and spaced repitition.</Typography>
        ...
        <Typography>
          ...
          Fill knowledge gaps seamlessly: Based on your quiz results, Sofanic provides personalized resources to help you strengthen your understanding and skills.
          Focus on what matters: By streamlining the studying process, Sofanic frees up your time and energy so you can concentrate on excelling in your chosen field.
          </Typography>
      </Grid>
      <Grid item xs={12}>
