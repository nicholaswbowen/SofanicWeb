...
const About = () => {
  return (
    <Grid container spacing={2} sx={{ margin: "20px" }}>
      ...
      <Typography variant="body1" paragraph>
        Whether you are a student striving for academic success or a professional looking to stay ahead in your career, StudyAssist is your ultimate learning companion. Experience the future of education with StudyAssist today.
      </Typography>
